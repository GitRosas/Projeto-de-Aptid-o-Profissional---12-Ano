    ...
    <div class="content">
        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                <h2><b>
                        <center>Alterar Professor</center>
                    </b></h2>
                <form name="form1" action="alterarProfessor1.php" method="POST">
                     <p>
                        <label>Número Cédula</label>
                        <input type="number" name="N_cedula"  value=<?php echo $N_cedula ; ?> readonly>
                    </p>
                    <p>
                    ...
                    <p>
                        <label>Idade</label>
                        <input type="number" name="idade1"  value=<?php echo $Idade ; ?> required>
                    </p>
                    <p>
