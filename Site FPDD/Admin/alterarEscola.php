        ...
        <div class="content">
            ...
            <div class="contact-wrapper animated bounceInUp">
                <div class="contact-form">
                    <h2><b>
                            <center>Alterar Escola</center>
                        </b></h2>
                    <form name="form1" action="alterarEscola1.php" method="POST">
                        <p>
                            <label>Código Escola</label>
                            <input type="text" name="Cod_Escola" value=<?php echo $Cod_Escola; ?> readonly>
                        </p>
                        <p>
                        ...
                        <p>
                            <label>Morada</label>
                            <input type="text" name="morada1" value=<?php echo $Morada; ?> required>
                        </p>
                        <p>
                            <label>Contacto</label>
                            <input type="number" name="contacto1" value=<?php echo $Contacto; ?> required>
                        </p>
                        <p>
                        <label>Código Associação</label>
                        <select name="Cod_Associacao1">
