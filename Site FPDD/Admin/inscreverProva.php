...
?>
    ...
    <body>
            ...
            <div class="content">
                ...
                <div class="contact-wrapper animated bounceInUp">
                    <div class="contact-form">
                        <h2><b>
                                <center>Inscrever Prova</center>
                            </b></h2>
                        <form name="form1" action="inscreverProva.php" method="POST">
                            <p>
                                <label>Nome Prova</label>
                                <input type="text" name="nome_prova" required>
                            </p>
                            <p>
                                <label>Escalão</label>
        ...
        if (isset($_POST["Registar"])) {
            ...
            if ($nome_prova == "") {
                echo "Preencha o campo do nome da prova";
            } else if ($escalao == "") {
                echo "Preencha o campo do escalão";
            } else if ($hora == "") {
                echo "Preencha o campo do nome da hora";
            }



            $stmt =  $pdo->prepare("INSERT INTO provas (Nome_Prova, Escalao, Hora) VALUES (?, ?, ?);");
            if ($stmt->execute(array($nome_prova, $escalao, $hora))) {
