...
?>
    ...
    <body>
            ...
            <div class="content">
                ...
                <div class="contact-wrapper animated bounceInUp">
                    <div class="contact-form">
                        <h2><b>
                                <center>Inscrever Juri</center>
                            </b></h2>
                        <form name="form1" action="inscreverJuris.php" method="POST">
                            <p>
                                <label>Código Juri</label>
                                <input type="text" name="Cod_Juri" required>
                            </p>
                            <p>
                                <label>Nome</label>
        ...
        if (isset($_POST["Registar"])) {
            ...
            if ($Cod_Juri == "") {
                echo "Preencha o campo do Codigo ";
            } else if ($Nome == "") {
                echo "Preencha o campo do nome";
            } else if ($Pais == "") {
                echo "Preencha o campo do nome do país";
            }


            $stmt =  $pdo->prepare("INSERT INTO juris (Cod_Juri, Nome, Pais) VALUES (?, ?, ?);");
            if ($stmt->execute(array($Cod_Juri, $Nome, $Pais))) {
