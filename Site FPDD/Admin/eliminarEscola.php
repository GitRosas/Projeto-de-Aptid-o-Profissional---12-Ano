...
$Codigo = $_GET["Cod_Escola"];

$stmt = $pdo->prepare("DELETE FROM `fpdd_final1`.`escolas` WHERE escolas.Cod_Escola = ?;");
$stmt->execute([$Codigo]);
$stmt2 = $pdo->prepare("select * from escolas WHERE escolas.Cod_Escola = ?;");
