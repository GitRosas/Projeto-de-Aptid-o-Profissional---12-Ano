    ...
    <div class="content">
        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                <h2><b>
                        <center>Alterar Juri</center>
                    </b></h2>
                <form name="form1" action="alterarJuri1.php" method="POST">
                     <p>
                        <label>Código Juri</label>
                        <input type="text" name="Cod_Juri"  value=<?php echo $Cod_Juri ; ?> readonly>
                    </p>
                    <p>
                        <label>Nome Juri</label>
                        <input type="text" name="nome1"  value=<?php echo $Nome ; ?> required>
                    </p>
                    <p>
                        <label>País</label>
                        <input type="text" name="pais1"  value=<?php echo $Pais ; ?> required>
                    </p>
                    <p class="block">
                        <button>
